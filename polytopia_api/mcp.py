...
TOOLS: list[dict[str, Any]] = [
    ...
    {
        "name": "local_move_to",
        "description": "Walk onto a city tile (city_id or x,y). Adjacent (~1 hex) clicks the city-foot / blue ring even when clustered move_marks are empty. Sticky city_id stays resolvable all turn. stood_on_city true only when the unit is ON the hex.",
        "inputSchema": {
            "type": "object",
            "properties": {
                "x": {"type": "integer"},
